...
export const App = () => {
  ...
  useEffect(() => {
    ...
    checkAndAutoInstallUpdate()
      ...
      .catch((e) => {
        // Временно не глушим ошибку молча — на этапе проверки автообновления
        // нужно видеть точный текст (например нехватку прав на запись).
        console.error("Автообновление: проверка не удалась", e);
        alert("Автообновление: ошибка проверки/установки — " + (e && e.message ? e.message : String(e)));
      });
