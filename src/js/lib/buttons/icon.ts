...
// файле локальной истории кнопок (см. history.ts), поэтому разумный потолок
// на размер важен, чтобы файл истории не раздувался до десятков МБ.
...
// читаем файл как есть, с полным data URL (не срезая префикс) — этот же data
// URL идёт прямо в src у <img>.
